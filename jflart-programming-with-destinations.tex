...
The implementation of \mintinline{haskellc}`fromIncomplete` is then relatively straightforward. It allocate a hollow \mintinline{haskellc}`¤Ur (□, □)` in the region, write the address of the now complete structure into it, and return the \mintinline{haskellc}`¤Ur`.
